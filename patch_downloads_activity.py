...
with open('app/src/main/java/com/fire/mangareader/activity/DownloadsActivity.java', 'r') as f:
    content = f.read()
...
if "setupBottomNavigation" not in content:
    content = content.replace('setContentView(R.layout.activity_downloads);', 'setContentView(R.layout.activity_downloads);\n        setupBottomNavigation();')
    last_brace = content.rfind('}')
    content = content[:last_brace] + bottom_nav_logic + content[last_brace:]

with open('app/src/main/java/com/fire/mangareader/activity/DownloadsActivity.java', 'w') as f:
    f.write(content)
