...
public interface MangaDao {
    ...
    java.util.List<com.fire.mangareader.data.database.LibraryItem> getAllFavorites();

    @Query("SELECT * FROM library")
    java.util.List<com.fire.mangareader.data.database.LibraryItem> getAllItems();
